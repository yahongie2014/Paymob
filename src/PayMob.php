    ...
    public function sample($method = null)
    {
        ...
        $auth = [
            ...
            'profile' => [
                ...
                'created_at' => "2019-05-31T14:50:26.417338",
                'active' => true,
                'profile_type' => "Merchant",
                'phones' => [ ],
                'company_emails' => [
                    "ahmed.saeed@4deve.com"
                ],
                'company_name' => "Serinc",
                'state' => "",
                'country' => "",
        ...
        $makeOrder = [
            "id" => 77614,
            "created_at" => "2019-05-30T20:20:43.455315",
            ...
            'obj' =>
                array (
                    ...
                    'order' =>
                        array (
                            'id' => 68010,
                            'created_at' => '2019-05-09T13:13:50.234703',
                            'delivery_needed' => false,
                            'merchant' =>
                                array (
                                    'id' => 180,
                                    'created_at' => '2019-05-20T14:50:26.417338',
                                    'phones' =>
                                        array (
                                        ),
                                    'company_emails' =>
                                        array (
                                            0 => 'ahmed.saeed@4deve.com',
                                        ),
                                    'company_name' => 'Serinc',
                                    'state' => NULL,
                                    'country' => NULL,
                    ...
                    'data' =>
                        array (
                            ...
                            'order_info' => 'a.saeed@programmer.net',
        ...
        $authCallback = [
            ...
            "is_3d_secure" => "false",
            "owner" => "197",
            "created_at" => "2019-05-30T15:39:21.786896",
            "success" => "true",
            "profile_id" => "180",
            "captured_amount" => "0",
            "data_message" => "Approved",
        ...
        $capture = [
            ...
            "created_at" => "2019-05-19T02=>42:47.874768",
            "transaction_processed_callback_responses" => [],
            "currency" => "EGP",
            "source_data" => [
                "pan" => "8769",
            ...
            "data" => [
                ...
                "klass" => "VPCCapture",
                "created_at" => "2010-05-19T00:42:49.288708",
